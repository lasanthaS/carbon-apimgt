...
//            KeyManagerHolder.initializeKeyManager(configuration);
    ...
    private void setupImagePermissions() throws APIManagementException {
        try {
            ...
            if (!UserManagerHolder.getUserManager().isRoleAuthorized(MultitenantConstants.SUPER_TENANT_ID,CarbonConstants.REGISTRY_ANONNYMOUS_ROLE_NAME, imageLocation, ActionConstants.GET )) {
                UserManagerHolder.getUserManager().authorizeRole(MultitenantConstants.SUPER_TENANT_ID, CarbonConstants.REGISTRY_ANONNYMOUS_ROLE_NAME, imageLocation, ActionConstants.GET);
            }
